...
router.get('/policies/items/:id', listPoliciesForItem);
router.get('/policies/templates', listPolicyTemplates);
...
router.get('/admin/policies', authorize('admin'), listAdminPolicies);
router.get('/admin/policies/:id', authorize('admin'), getAdminPolicy);
router.post('/admin/policies', authorize('admin'), createPolicy);
router.put('/admin/policies/:id', authorize('admin'), updatePolicy);
router.delete('/admin/policies/:id', authorize('admin'), deletePolicy);
