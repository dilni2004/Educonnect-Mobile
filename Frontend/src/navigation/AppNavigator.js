...
import ManageKBPoliciesScreen from '../screens/ManageKBPoliciesScreen';
    ...
    <Stack.Navigator>
      {userToken === null ? (
        ...
        <>
          ...
          <Stack.Screen name="ManageKBPolicies" component={ManageKBPoliciesScreen} options={{ title: 'Knowledgebase Policies' }} />
        </>
      )}
    </Stack.Navigator>
  );
