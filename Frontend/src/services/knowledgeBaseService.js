...
export const getKBPolicies = async () => {
  const response = await api.get('/kb/policies');
  return response.data;
};

export const getAdminKBPolicies = async () => {
  const response = await api.get('/kb/admin/policies');
  return response.data;
};

export const createKBPolicy = async (policyData) => {
  const response = await api.post('/kb/admin/policies', policyData);
  return response.data;
};

export const updateKBPolicy = async (policyId, policyData) => {
  const response = await api.put(`/kb/admin/policies/${policyId}`, policyData);
  return response.data;
};

export const deleteKBPolicy = async (policyId) => {
  const response = await api.delete(`/kb/admin/policies/${policyId}`);
  return response.data;
};
